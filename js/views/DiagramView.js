    ...
    return Marionette.Object.extend({
        ...
        updateFromCollection: function() {
            ...
            _.chain(self.collection.models)
                .sort(function(a) { return BasicLayout.types[a.get("type")].layer || 0 })
...
//            this.containers['pool-g'].append("g").html(this.disabledZoneTpl());
        ...
        createViewByModel: BasicLayout.createViewByModel.bind(BasicLayout),

        addTempViewModel: function (model) {
            var self = this;
            this.draggedViewModel = BasicLayout.createViewByModel(model, self, true);
        ...
        viewModelByModel: function(model) {
            return BasicLayout.createViewByModel(model, this, false, true);
        },

        addNewActivityViaModel: function(model) {
            var view = BasicLayout.createViewByModel(model, this, false);
        ...
        getContainer: function (targetType, isTemp) {
            ...
            containerName = BasicLayout.getElementContainer(targetType || this.activeType);
