...
define([
    './SubactivityView',
    'module/d3Graphics',
    'text!../../templates/bpmn/titleArea.html'
], function (SubactivityView, d3Graphics, titleAreaTemplate) {
    'use strict';
    var ActivityViewModel;
    var d3 = d3Graphics.d3;
    var helpers = d3Graphics.helpers;

    ActivityViewModel = Marionette.Object.extend({
        ...
        initialize: function (cfg) {
            ...
            this.isTemp = cfg.isTemp;
            this.model = cfg.model;
            this.parent = cfg.parent;
            this.isHidden = cfg.isHidden;
