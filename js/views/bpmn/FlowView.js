...
define([
    ...
    './../../utils/aStarSearch',
    'module/d3Graphics'
], function (ActivityViewModel, ElementViewConfigs, astar, d3Graphics) {
    'use strict';
    ...
    var FlowViewModel = ActivityViewModel.extend({
        ...
        flowLineMouseDown: function () {
            if (this.model.isLinkedWithActivity())
                return;
        ...
        getStrokeAttrs: function(isLast) {
            var basic = ElementViewConfigs.get(this.getType());
        ...
        drawMarkerArrow: function () {
            ...
            var cfg = ElementViewConfigs.getViewGfg(this.getType());
