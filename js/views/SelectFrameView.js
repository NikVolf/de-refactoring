/**
 * Created by nvolf on 16.10.2014.
 */
define(['module/d3Graphics'], function(d3Graphics) {

    'use strict';

    var SelectFrameView = Marionette.Object.extend({
        ...
        getRegularizedPlacedRect: function() {
            return d3Graphics.helpers.regularizeRect(this.getPlacedRect());
        },
        ...
        render: function() {
            this.contentElement = d3Graphics.helpers.appendTranslatedGroup(this.container, this.translatedAnchor);
